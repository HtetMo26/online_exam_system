                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5" style="margin-bottom:50px; background-color:#0A3B75;">
                                    <div class="card-header"><h3 class="text-center text-white font-weight-light my-4">Login as Admin</h3></div>
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small" style="color:#958B8B;">Don't have an account yet? <a class="text-white" href="Admin_Register.php">Register here.</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>

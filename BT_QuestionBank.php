<?php  
    ...
    if(isset($_POST['btnSave'])) 
    {
        ...
        if ($result){
            echo "<script>window.alert('Blank Type created successfully in Question Bank.')</script>";
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4 bg-dark">
                            <li class="breadcrumb-item active text-light"><a class="link text-decoration-none text-white" href="Question_Bank.php">Question Bank</a> > <a class="link text-decoration-none text-white" href="New_Question.php">New Question</a> > <a class="link text-decoration-none text-white" href="BT_QuestionBank.php">Blank Type</a></li>
                        </ol>   
                    </div>

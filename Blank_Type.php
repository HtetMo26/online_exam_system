        ...
        if(isset($_POST['btnAddBT'])) 
            {
                ...
                $count = mysqli_num_rows($exist);
                    ...
                    $result2 = mysqli_query($connection,$query2);
                        ...
                        //Insert BT Data into BT Table------------------------------------------------------------------------------------

                        $txtAnswer = $_POST['txtAnswer'];

                        $query = "INSERT INTO blank_type
                        (QuestionID,Answer)
                        VALUES ('$_QuestionID','$txtAnswer')";

                        $result = mysqli_query($connection,$query);

                            if ($result){
                                echo "<script>window.alert('Blank Type added successfully.')</script>";
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 text-white">Blank Type</h1>
                        <ol class="breadcrumb mb-4 bg-dark">
                            <li class="breadcrumb-item active text-light"><a class="link text-decoration-none text-white" href="Test_Page.php">Tests</a> > <a class="link text-decoration-none text-white" href="New_Test.php">New Test</a> > <a class="link text-decoration-none text-white" href="Add_Question.php">Add Question</a> > <a class="link text-decoration-none text-white" href="Blank_Type.php">Blank Type</a></li>
                        </ol>   
                    </div>
                    <div class="container-fluid px-4 d-flex justify-content-center">
                        <div class="card p-5" style="width:50rem; margin-top:20px; margin-bottom:50px;">
                            <div class="card-body">
                                <form id="addbt" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="Answer" class="form-control border border-dark" name="txtAnswer" placeholder="Answer" required />
                                    </div>
                                    <input type="submit" class="btn btn-dark float-right" name="btnAddBT" value="Save" />                                
                                </form>
                            </div>
                        </div>
                    </div>           

        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                    <h1 class="mt-4 text-white">Issued Results</h1>
                    <ol class="breadcrumb mb-4 bg-dark">
                        <li class="breadcrumb-item active text-light"><a class="link text-decoration-none text-white" href="Issued_Result.php">Issued Results</a></li>
                    </ol>
                </div>
                <div class="container-fluid px-4">
                        ...
                        <table class="table table-hover table-light" style="margin-top:20px; margin-bottom:35px;">
                            ...
                            <?php
                                for($i=0;$i<$count;$i++) 
                                {
                                    ...
                                    echo "<td>" . $rows['FinalScores'] . "</td>";
                                    echo "<td>" . $rows['Grade'] . "</td>";
                                    echo "<td>" . $rows['PassOrFail'] . "</td>";
                                    echo "<td>" . $rows['Comment'] . "</td>";                    
                                    echo "<td>" . $rows['IssuedDate'] . "</td>";
                                    echo "<td>" . "<a href='Edit_Result.php?ResultID=$ResultID' class='btn btn-outline-dark' role='button' aria-pressed='true'>Edit Result</a>" . "</td>";
                                    echo "</tr>";
                                    echo "</tbody>";
                                }          

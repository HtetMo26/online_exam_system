                ...
                foreach ($option as $key => $optionValue){
                    if ($optionValue != ''){
                        if ($CorrectAnswer == $key){
                            ...
                            VALUES('$optionValue','$_QuestionID','1')";
                        }
                        else{
                            $query = "INSERT INTO multiplechoice
                            (Answer,QuestionID,CorrectAnswer)
                            VALUES('$optionValue','$_QuestionID','0')";
                        }
                    ...
                    if ($insertOption){
                        echo "<script>window.alert('Multiple Choice created successfully in Question Bank.')</script>";
                        echo "<script>window.location='Question_Bank.php'</script>";
                    }
                    else{
                        echo "<script>window.alert('Something went wrong in creating the question. Please try agian.')</script>";
...
<html lang="en">
    <head>
        ...
        <title>Multiple Choice - QB</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4 bg-dark">
                            <li class="breadcrumb-item active text-light"><a class="link text-decoration-none text-white" href="New_Question.php">New Question</a> > <a class="link text-decoration-none text-white" href="MC_QuestionBank.php">Multiple Choice</a></li>
                        </ol>   
                    </div>
                            ...
                            <div class="card-body">
                                <form id="addmc" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">    
                                        ...
                                        <input type="number" class="form-control border border-dark" id="Correct" min=1 name="CorrectAnswer" placeholder="If Option A is correct, type '1'." required />	
                                    </div>   

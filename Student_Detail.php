<?php
    ...
    if(!isset($_GET['StudentID'])) 
    {
        ...
        $StudentPhoto = $rows['ProfilePicture'];
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 text-white">Profile Details</h1>
                        <ol class="breadcrumb mb-4 bg-dark">
                            <li class="breadcrumb-item active text-light"><a class="link text-decoration-none text-white" href="Student_Profiles.php">Student Profiles</a> > <?php echo "<a href='Student_Detail.php?StudentID=$StudentID' class='link text-decoration-none text-white'>Profile Details</a>" ?> </li>
                        </ol>
                    </div>
                    <div class="container-fluid px-4 d-flex justify-content-center">
                        <div class="card shadow p-5 bg-dark" style="width:40rem; margin-top:20px; margin-bottom:50px;">
                            <div class="card-body text-white">
                                <h5 class="card-title"><i class="fas fa-user-graduate"></i>&nbsp;&nbsp;Student Profile Details</h5>
                                <h6 class="card-subtitle mb-2 text-white">Click "Update" to change student information.</h6>
                                <table class="table text-white">
                                    ...
                                    <tr>
                                        ...
                                        <td><img src='<?php echo $StudentPhoto ?>' width='100px' height='100px'/></td>
                                    </tr>
                                    <tr>
                                        <th>Full Name</th>
                                ...
                                <a href="Student_Update.php" class="card-link text-primary">Update</a>
                                <a href="Student_Profiles.php" class="card-link text-primary float-right">Back</a>
                            </div>
                        </div>

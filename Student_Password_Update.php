...
if(isset($_POST['btnUpdate'])) 
{
    ...
    elseif($txtCurrentPassword !== $rows['Password'])
    {
		...
		echo "<script>window.location='Student_Password_Update.php'</script>";
    }
                ...
                <main>
					<div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb bg-dark mb-4">
                            <li class="breadcrumb-item active text-light"><a class="link text-decoration-none text-white" href="Student_Profile.php">Your Profile</a> > <a class="link text-decoration-none text-white" href="Student_Password_Update.php">Update Password</a></li>
                        </ol>
                    </div>

                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb bg-dark mb-4">
                            <li class="breadcrumb-item active text-light"><a class="link text-decoration-none text-white" href="Student_Profile.php">Your Profile</a></li>
                        </ol>
                    </div>
                    <div class="container-fluid px-4 d-flex justify-content-center">                       
                        <div class="card shadow p-5" style="width:40rem; margin-top:20px; margin-bottom:50px;">
                            <div class="card-body">
                                ...
                                <a href="Student_Profile_Update.php" class="card-link">Update</a>
                                <a href="Student_Password_Update.php" class="card-link float-right">Update Password</a>
                            </div>
                        </div>
                    </div>            
                </main>

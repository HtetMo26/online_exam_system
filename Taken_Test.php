        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                    <h1 class="mt-4 text-white">Taken Tests</h1>
                    <ol class="breadcrumb mb-4 bg-dark">
                        <li class="breadcrumb-item active text-light"><a class="link text-decoration-none text-white" href="Taken_Test.php">Taken Tests</a></li>
                    </ol>
                </div>
                <div class="container-fluid px-4">
                    ...
                    <table class="table table-hover table-dark" style="margin-top:0px; margin-bottom:35px;">
                        ...
                        <?php
                            for($i=0;$i<$count;$i++) 
                            {
                                ...
                                echo "<td>" . $count2 . "</td>";
                                echo "<td>" . "<a href='Result_Page.php?TestID=$TestID' class='btn btn-outline-light' role='button' aria-pressed='true'>View Results</a>";
                                echo "</tr>";
                                echo "</tbody>";
                            }          
